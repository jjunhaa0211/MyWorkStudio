...
class SessionStore {
    ...
    func writeRecoveryBundle(for saved: SavedSession, reason: String) -> URL? {
        ...
        do {
            ...
            print("[WorkMan] Failed to create recovery bundle: \(error)")
            return nil
        }
        ...
        do {
            ...
            print("[WorkMan] Failed to write recovery README: \(error)")
            return nil
        }
    }
    ...
    private func copyChangedFiles(_ files: [SavedFileChange], projectPath: String, destinationRoot: URL) -> [String] {
        ...
        for file in uniqueFiles {
            ...
            do {
                ...
                print("[WorkMan] Failed to copy recovery file \(sourceURL.path): \(error)")
            }
        }
