...
struct WorkerLevel {
    ...
    private static let titleTiers: [TitleTier] = [
        TitleTier(minLevel: 1, title: "인턴", badge: "🌱"),
        TitleTier(minLevel: 2, title: "주니어", badge: "🔰"),
        TitleTier(minLevel: 3, title: "미들", badge: "⚙️"),
        TitleTier(minLevel: 5, title: "시니어", badge: "🔧"),
        TitleTier(minLevel: 7, title: "리드", badge: "⭐"),
        TitleTier(minLevel: 10, title: "아키텍트", badge: "🏗"),
        TitleTier(minLevel: 13, title: "CTO", badge: "🎯"),
        TitleTier(minLevel: 16, title: "전설", badge: "🏆"),
        TitleTier(minLevel: 20, title: "신", badge: "👑"),
        TitleTier(minLevel: 25, title: "우주", badge: "🌌"),
        TitleTier(minLevel: 30, title: "성운", badge: "🌠"),
