...
public class AchievementManager: ObservableObject {
    ...
    @Published public var commandCount: Int = 0
    @Published public var recentUnlock: Achievement?

    // 확장 추적 변수
    @Published public var totalSessions: Int = 0
    @Published public var totalCompletions: Int = 0
    @Published public var totalTokensUsed: Int = 0
    @Published public var totalCost: Double = 0
    @Published public var errorRecoveryCount: Int = 0
    @Published public var totalFileEdits: Int = 0
    @Published public var totalFileReads: Int = 0
    @Published public var usedModels: Set<String> = []
    @Published public var uniqueBranches: Set<String> = []
    @Published public var activeDays: Set<String> = []  // "yyyy-MM-dd" 형식
    @Published public var nightDays: Set<String> = []   // 심야 작업한 날
    @Published public var weekendDays: Set<String> = [] // 주말 작업한 날
    @Published public var lastLoginRewardDate: String = ""  // "yyyy-MM-dd"
    @Published public var loginStreak: Int = 0
    @Published public var todayRewardClaimed: Bool = false
    ...
    @Published public var unlockedCount: Int = 0
    public var currentLevel: WorkerLevel { WorkerLevel.forXP(totalXP) }
    ...
    public func dismissRecentUnlock() {
    ...
    public struct DailyRewardResult {
        ...
        public let milestoneEmoji: String
        public let milestoneLabel: String
    }

    public func claimDailyReward() -> DailyRewardResult? {
        let today = dayFormatter.string(from: Date())
    ...
    public func recordFileRead(sessionReadCount: Int) {
        totalFileReads += 1
    ...
    public func recordModel(_ model: String) {
    ...
    public func recordBranch(_ branch: String) {
    ...
    public func checkSessionAchievements(tabs: [TerminalTab]) {
    ...
    public func checkCompletionAchievements(tab: TerminalTab) {
        totalCompletions += 1
        totalSessions += 1
    ...
    public func checkErrorRecovery() {
