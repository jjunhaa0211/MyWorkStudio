...
public class SessionManager: ObservableObject {
    ...
    @Published public private(set) var cachedSearchResults: [SearchResult] = []
    ...
    @Published public private(set) var availableReportCount: Int = 0
    ...
    private func findCodexCodeSessions() -> [DetectedSession] {
        var results: [DetectedSession] = []
    ...
    private func findCodexPidsNative() -> [Int] {
        let bufferSize = proc_listallpids(nil, 0)
        guard bufferSize > 0 else { return [] }
    ...
    private func getAgentProjectPath(pid: Int) -> String? {
